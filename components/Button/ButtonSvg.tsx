...
interface ButtonSvgProps extends React.SVGProps<SVGSVGElement> {
    id: string,
}

export const ButtonSvg = ({id}:ButtonSvgProps) => {
    switch (id) {
        case 'svg':
            return (
                <svg width="6" height="10" fill="#3B434E" viewBox="0 0 6 10" xmlns="http://www.w3.org/2000/svg">
