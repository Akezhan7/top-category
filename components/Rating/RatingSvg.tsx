...
interface RatingSvgProps extends React.SVGProps<SVGSVGElement> {
    id: string,
}

export const RatingSvg = ({id, className, ...props}:RatingSvgProps):JSX.Element => {
    switch (id) {
        case 'svg':
            return (
                <svg className={className} width="20" height="20" viewBox="0 0 20 20" fill="#E2E2E2" xmlns="http://www.w3.org/2000/svg" {...props}>
